    ...
    <footer className="bg-footer-bg full-width mt-auto">
      <AnimatedContainer animation="fadeInUp" once={true} className="w-full py-[64px] px-4 md:px-[32px] flex flex-col md:flex-row justify-between items-start gap-[48px] max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-[12px] md:ml-auto">
          ...
          <a className="text-[1rem] text-border opacity-80 hover:opacity-100 transition-opacity hover:text-primary" href="/iklim/peringatan-dini">Peringatan Dini</a>
          ...
          <a className="text-[1rem] text-border opacity-80 hover:opacity-100 transition-opacity hover:text-primary" href="/pelayanan-publik/pengaduan">Pengaduan & Survei</a>
        </div>
