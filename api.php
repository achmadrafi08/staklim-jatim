...
if (empty($station)) {
    ...
    $availableStations = [
        "aws_malang", "aws_batu", "aws_bondowoso", "aws_bromo", "aws_kandat", 
        ...
        "aws_stageof_pasuruan", "aws_stageof_sawahan",
...
// Ganti dengan URL dan Anon Key Supabase milik instansi BMKG Anda:
